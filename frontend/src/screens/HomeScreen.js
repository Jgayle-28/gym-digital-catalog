                  ...
                  <div class='d-flex h-100'>
                    <div class='project-text w-100 my-auto text-center text-lg-left'>
                      ...
                      <p class='mb-0 text-white-50'>
                        No longer do you have to leave the comfort of your home
                        to experience a full body workout! ​Black Iron Strength
                ...
                <div class='bg-black text-center h-100 project'>
                  <div class='d-flex h-100'>
                    <div class='project-text w-100 my-auto text-center text-lg-right'>
                      ...
                      <p class='mb-0 text-white-50'>
                        If you are looking for a full body workout experience
                        for your home or commercial gym, then here are the
              ...
              <div class='col-xl-4 col-lg-5'>
                <div class='featured-text-left text-center text-lg-left'>
                  ...
                  <p class='text-black-50 mb-0'>
                    ...
                    receive our equipment. ​We give multiple options for
                    payments such as cash, check or online payments such as
                    Venmo or Zelle! Whatever works best for you is our preferred
                    method.
                  </p>
                </div>
              </div>
